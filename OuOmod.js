// ==UserScript==
// @name           ミ☯☯★♛⬢™ỐuỒ™⬢♛★☯☯彡 Mod{(Fix By ouo)change By ouo too}and+Radar!
// @namespace    Best Hack 2020
// @version      Last_Version
// @description  By ouo
// @author        ouo (edited by Nuro)
// @match        *://moomoo.io/*
// @match        *://dev.moomoo.io/*
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports.nameY = 34,
        e.exports.skinColors = ["#FFFFFF", "#000000", "#FF0000", "#FFD700", "#228B22", "#00008B", "#8B008B", "#483D8B", "#808080", "#FF4500"],
        e.exports.animalCount = 7,
        e.exports.aiTurnRandom = .106,
        e.exports.cowNames = ["ζ͜͡𝕃𝕚𝕠𝕟 𝕄𝕠𝕕"],
...
, function(e, t, n) {
    ...
    var at = document.getElementById("featuredYoutube")
      , ot = [{
        name: "Instakiller Squad",
        link: "https://www.youtube.com/channel/UCNGEdq2mT2P7QfoZ0oapnQg/videos?view_as=subscriber"
    }]
			...
			for (var t, n = 0; n < ln.length; ++n)
				if (e.indexOf(ln[n]) > -1) {
                    ...
                    for (var i = 0; i < ln[n].length; ++i)
                        t += t.length ? "GoDZ-INSTAKILLER SQUAD AND AFK-GoDZ-INSTAKILLER  SQUAD AND AFK-GoDZ GoDZ-INSTAKILLER SQUAD AND AFK-GoDZ-INSTAKILLER  SQUAD AND AFK-GoDZ GoDZ-INSTAKILLER SQUAD" : "GoDZ-INSTAKILLER SQUAD AND AFK-GoDZ-INSTAKILLER  SQUAD AND AFK-GoDZ GoDZ-INSTAKILLER SQUAD AND AFK-GoDZ-INSTAKILLER  SQUAD AND AFK-GoDZ GoDZ-INSTAKILLER SQUAD";
    ...
    function Dn(e, t, n) {
        ...
        He.style.width = "100%") : (ze.innerHTML = " " + R.age,
    ...
    function ri(e, t) {
        ...
        if (!n || t) {
            ...
            "apple" == e.name) {
                ...
                r.fillStyle = "castle wall" == e.name ? "#DB2929" : "wood wall" == e.name ? "#DBFEF8" : "#DBE6E0";
                var f = "castle wall" == e.name ? 4 : 3;
                ai(r, f, 1.1 * e.scale, 1.1 * e.scale),
                r.fill(),
                r.stroke(),
                r.fillStyle = "castle wall" == e.name ? "#FF8C00" : "wood wall" == e.name ? "#FF4500" : "#FF0000",
                ai(r, f, .65 * e.scale, .65 * e.scale),
                r.fill()
            } else if ("spikes" == e.name || "greater spikes" == e.name || "poison spikes" == e.name || "spinning spikes" == e.name) {
                r.fillStyle = "poison spikes" == e.name ? "#FF4500" : "#COCOCO";
                var d = .6 * e.scale;
                ...
                "healing pad" == e.name ? (r.fillStyle = "#8B008B",
                oi(0, 0, 2 * e.scale, 2 * e.scale, r),
                r.fill(),
                r.stroke(),
                r.fillStyle = "#FF4500",
                ci(0, 0, .65 * e.scale, 20, 4, r, !0)) : "spawn pad" == e.name ? (r.fillStyle = "#8B008B",
                oi(0, 0, 2 * e.scale, 2 * e.scale, r),
                r.fill(),
                r.stroke(),
                r.fillStyle = "#FF4500",
                si(0, 0, .6 * e.scale, r)) : "blocker" == e.name ? (r.fillStyle = "#FF4500",
                si(0, 0, e.scale, r),
                r.fill(),
                r.stroke(),
                r.rotate(Math.PI / 4),
                r.fillStyle = "#FF0000",
                ci(0, 0, .65 * e.scale, 20, 4, r, !0)) : "teleporter" == e.name && (r.fillStyle = "#FF4500",
                si(0, 0, e.scale, r),
                r.fill(),
                r.stroke(),
                r.rotate(Math.PI / 4),
        ...
        function() {
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    ...
                    var _0x1b69=["\x6C\x69\x6E\x65\x43\x61\x70","\x72\x6F\x75\x6E\x64","\x73\x74\x72\x6F\x6B\x65\x53\x74\x79\x6C\x65","\x23\x30\x30\x30\x30\x30\x30","\x6C\x69\x6E\x65\x57\x69\x64\x74\x68","\x62\x65\x67\x69\x6E\x50\x61\x74\x68","\x78","\x79","\x6D\x6F\x76\x65\x54\x6F","\x6C\x69\x6E\x65\x54\x6F","\x73\x74\x72\x6F\x6B\x65","\x66\x6F\x6E\x74","\x6E\x61\x6D\x65\x53\x63\x61\x6C\x65","\x70\x78\x20\x48\x61\x6D\x6D\x65\x72\x73\x6D\x69\x74\x68\x20\x4F\x6E\x65","\x66\x69\x6C\x6C\x53\x74\x79\x6C\x65","\x23\x66\x66\x66","\x74\x65\x78\x74\x42\x61\x73\x65\x6C\x69\x6E\x65","\x6D\x69\x64\x64\x6C\x65","\x74\x65\x78\x74\x41\x6C\x69\x67\x6E","\x63\x65\x6E\x74\x65\x72","\x6C\x69\x6E\x65\x4A\x6F\x69\x6E","\x62\x6C\x61\x63\x6B","\x4E\x42","\x73\x74\x72\x6F\x6B\x65\x54\x65\x78\x74","\x66\x69\x6C\x6C\x54\x65\x78\x74"];if(_!= R){be[_0x1b69[0]]= _0x1b69[1];be[_0x1b69[2]]= _0x1b69[3];be[_0x1b69[4]]= 3;be[_0x1b69[5]]();be[_0x1b69[8]](R[_0x1b69[6]]- f,R[_0x1b69[7]]- d);be[_0x1b69[9]](_[_0x1b69[6]]- f,_[_0x1b69[7]]- d);be[_0x1b69[10]]();be[_0x1b69[2]]= nt};if(_!= R){be[_0x1b69[11]]= (_[_0x1b69[12]]|| 25)+ _0x1b69[13],be[_0x1b69[14]]= _0x1b69[15],be[_0x1b69[16]]= _0x1b69[17],be[_0x1b69[18]]= _0x1b69[19],be[_0x1b69[4]]= _[_0x1b69[12]]?11:8,be[_0x1b69[20]]= _0x1b69[1],be[_0x1b69[2]]= _0x1b69[21],be[_0x1b69[23]](_0x1b69[22],(R[_0x1b69[6]]- f+ _[_0x1b69[6]]- f)/ 2,(R[_0x1b69[7]]- d+ _[_0x1b69[7]]- d)/ 2),be[_0x1b69[24]](_0x1b69[22],(R[_0x1b69[6]]- f+ _[_0x1b69[6]]- f)/ 2,(R[_0x1b69[7]]- d+ _[_0x1b69[7]]- d)/ 2)}
                    ...
                    be.fill(),
                    be.fillStyle = _ == R || _.team && _.team == R.team ? "#FF8C00" : "orangered",
...
, function(e, t) {
    ...
    e.exports.accessories = [{
        ...
        scale: 97,
        xOff: 25,
        desc: "You'll be Zoooming With This :3",
        spdMult: 1.35,
        dmgMultO: .2
    }, {
        id: 17,
...
var YouName = window.prompt("You Name (ouo Or pain):","");
...
newImg.src = "https://media.discordapp.net/attachments/708322501280792658/708323975641563206/images.png";
newImg.style = `position: absolute; top: 135px; left: 86%; z-index: 100000; width: 75px; height: 75px; cursor: pointer; border-radius: 75px; padding: 5px; border: 9px solid;`;
...
(function() {
	...
	document.addEventListener('keydown', function (e) {
		if (e.keyCode == 109 && document.activeElement.id.toLowerCase() !== 'chatbox') {
            ...
            autoaim = true;
            doNewSend(["7", [2]]);
            animal1 = setTimeout(function(){ h1(); }, 0);
			} else {
    ...
    clearTimeout(animal1);
    animal2 = setTimeout(function(){ h2(); }, 270);
    }
    function h2() {
    doNewSend(["13c", [0, 7, 0]]);
            acc(21);
    doNewSend(["ch", ['Im Gay ouo!']]);
    doNewSend(["33", [nearestEnemyAngle]]);
    if(isEnemyNear == true) {
            for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    ...
    clearTimeout(animal2);
    animal3 = setTimeout(function(){ h3(); }, 270);
    }
    function h3() {
    doNewSend(["13c", [0, 53, 0]]);
            acc(11);

    doNewSend(["ch", ['Im Best Pro!']]);
    doNewSend(["33", [nearestEnemyAngle]]);
    if(isEnemyNear == true) {
            for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    ...
    clearTimeout(animal3);
    animal4 = setTimeout(function(){ h4(); }, 270);
    }
    function h4() {
    doNewSend(["13c", [0, 11, 0]]);
            acc(21);
    doNewSend(["ch", ['Im Super!']]);
    doNewSend(["33", [nearestEnemyAngle]]);
    if(isEnemyNear == true) {
            for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    ...
    clearTimeout(animal4);
    animal5 = setTimeout(function(){ h5(); }, 270);
    }
    function h5() {
    ...
    clearTimeout(animal5);
    animal6 = setTimeout(function(){ h6(); }, 270);
    }
    function h6() {
    doNewSend(["13c", [0, 7, 0]]);
            acc(21);

    doNewSend(["ch", ['Im Pain Best friend!']]);
    doNewSend(["33", [nearestEnemyAngle]]);
    if(isEnemyNear == true) {
            for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    ...
    clearTimeout(animal6);
    animal7 = setTimeout(function(){ h7(); }, 270);
    }
    function h7() {
    doNewSend(["13c", [0, 11, 0]]);
            acc(16);

    doNewSend(["ch", ['u lost on me!']]);
    doNewSend(["33", [nearestEnemyAngle]]);
    if(isEnemyNear == true) {
            for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    ...
    clearTimeout(animal7);
    animal1 = setTimeout(function(){ h1(); }, 270);
    }
})();
...
(function() {
	...
	document.addEventListener('keydown', function (e) {
            if (e.keyCode == 109 && document.activeElement.id.toLowerCase() !== 'chatbox') {
			e.preventDefault();
            if(Math.sqrt(Math.pow((myPlayer.y-nearestEnemy[2]), 2) + Math.pow((myPlayer.x-nearestEnemy[1]), 2)) < 30) {
            isEnemyNear = true
            };
			if (policeMod) {
            autoaim = true;
            doNewSend(["7", [2]]);
            police1 = setTimeout(function(){ h1(); }, 0);
			} else {
    ...
    clearTimeout(police1);
    police2 = setTimeout(function(){ h2(); }, 500);
    }
    function h2() {
    doNewSend(["13c", [0, 15, 0]]);
    doNewSend(["ch", ['Run Or Die :D']]);
    doNewSend(["33", [nearestEnemyAngle]]);
    if(isEnemyNear == true) {
            for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    ...
    clearTimeout(police2);
    police1 = setTimeout(function(){ h1(); }, 500);
    }
})();
...
(function() {
    ...
    function h1() {
        ...
        doNewSend(["8", ['Pen']])
    clearTimeout(Pen1);
    Pen2 = setTimeout(function(){ h2(); }, 500);
    }
    function h2() {
        doNewSend(["9", [null]]);
        doNewSend(["8", ['Never']])
    clearTimeout(Pen2);
    Pen3 = setTimeout(function(){ h3(); }, 500);
    }
    function h3() {
        doNewSend(["9", [null]]);
        doNewSend(["8", ['Lose']])
    clearTimeout(Pen3);
    Pen4 = setTimeout(function(){ h4(); }, 500);
    }
    function h4() {
        doNewSend(["9", [null]]);
        doNewSend(["8", [':D']])
    clearTimeout(Pen3);
    Pen1 = setTimeout(function(){ h1(); }, 1000);
    }
})();
...
if(e.keyCode == 82 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        doNewSend(["c", [1]]);
       doNewSend(["ch", ["/-Speed-/._./185 By cute ouo!/"]]);
   ...
   if(e.keyCode == 97 && document.activeElement.id.toLowerCase() !== 'chatbox') {
    ...
    //Bot Toggle
    if(e.keyCode == 59 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if (autoaim == false) {
            autoaim = true;
        document.title = "ouoMod / Aim : On";
        } else {
        document.title = "ouoMod / Aim : Off";
            autoaim = false;
    }
    }
...
checkbox.addEventListener('change', function() {
    if (this.checked) {
        $("#mapDisplay").css({background: `url('https://media.discordapp.net/attachments/708322501280792658/708323975641563206/images.png')`});
        console.log('checked')
    } else {
...
document.getElementById('loadingText').innerHTML = '☯️ . . . . . . . . 🐉𝕃𝐨𝗮𝕕 ouo𝕄𝗼𝕕🐉 . . . . . . . . . ☯️';
document.getElementById('nameInput').placeholder = "ouo𝕄𝗼𝕕";
document.getElementById('chatBox').placeholder = "╰ouo𝕄𝗼𝕕╮";
...
document.getElementById('gameName').innerHTML = '  ⛔🐲ouo𝕄𝗼𝕕🐲⛔  ';
