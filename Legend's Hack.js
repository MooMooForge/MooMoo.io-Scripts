...
// ==UserScript==
// @name           MooMoo.io | Legend's Hack | 2020
// @namespace      -
// @version          Legend mod 1.0
// @description    -
// @author         Nuro
// @match          *://moomoo.io/*
// @match          *://dev.moomoo.io/*
...
$('#menuContainer').append('If you want join clan click on LS top left')

$("#youtuberOf").css({display: "none"});
let newImg = document.createElement("img");
newImg.src = "https://cdn.discordapp.com/icons/666682930977832970/9132b679e2a83b3b303757d90b406a75.png?size=128&quot";
newImg.style = `position: absolute; top: 15px; left: 15px; z-index: 100000; width: 50px; height: 50px; cursor: pointer;`;
document.body.prepend(newImg);

newImg.addEventListener("click", () => {
       let w = window.open("https://discord.gg/4T7ekFC", null, `height=650, width=1199, status=yes, toolbar=no, menubar=no, location=no`);
});
...
document.getElementById('loadingText').innerHTML = '. . . . . . . . . Load Legend hack . . . . . . . . .  ';
document.getElementById('nameInput').placeholder = "PInK";
document.getElementById('chatBox').placeholder = "Legend hack";
document.getElementById('diedText').innerHTML = 'ah shit there we go again';
...
document.getElementById("gameName").innerHTML = "Legend's hack"
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">Legend mod - Settings</h2>
        </div>
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 111 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                document.title = "Heal - off|Legend mod"
            } else {
                document.title = "Heal - off|Legend mod"
            }
        } else {
            if(hatToggle == 0) {
                document.title = "Heal - on|Legend mod"
            } else {
                document.title = "Heal - on|Legend mod"
            }
        }
